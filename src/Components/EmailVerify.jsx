...
const EmailVerify = () => {
    ...
    const handleVerify = async () => {
        try {
            setIsVerifying(true)
            const response = await axios.post(`${api}/api/solve_litigation/verification/verify-email/${token}`)
                ...
                >
                    ...
                    {(result === 'verified' || result === 'alreadyVerified') && (
                        <div className='flex-col gap-10'>
                            ...
                            <div>
                                <p className="text-center text-3xl py-5 font-bold">Email has been verified.</p>
                                <div >
                                    <div className='w-full py-3 flex justify-center'>
                                        <Link to={'/login'}>
                                            <PrimaryButton type={'submit'}
                        ...
                        <div className='flex-col gap-10'>
                            ...
                            <div>
                                <p className="text-center text-xl py-5 font-bold">Verification link has been expired!</p>
                                <div >
                                    <div className='w-full py-3 flex justify-center'>
                                    </div>
                                </div>
