...
const SelectServiceModal = ({ isOpen, setIsOpen }) => {
    ...
    useEffect(() => {
        if (isOpen) {
            ...
            axios.get(`${api}/api/solve_litigation/auth/get-selected-service/${user._id}`, {
                headers: {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await axios.put(`${api}/api/solve_litigation/auth/update-selected-service/${user._id}`, {
            ...
            <Modal isOpen={isOpen} onClose={() => setIsOpen(false)}>
                ...
                <ModalContent>
                    ...
                    <ModalFooter>
                        ...
                        <PrimaryButton isLoading={isSubmitting} loadingText={'Submitting...'} title={'Submit'} onClick={handleSubmit} />
                    </ModalFooter>
                </ModalContent>
            </Modal>
        </div>
